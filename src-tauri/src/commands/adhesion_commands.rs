...
pub async fn creer_adhesion(
    ...
    repositories::adhesion_repo::create(&state.pool, input).await
}
...
pub async fn modifier_adhesion(
    ...
    repositories::adhesion_repo::update(&state.pool, id, input).await
}
...
pub async fn lister_adhesions_personne(
    ...
    repositories::adhesion_repo::list_by_personne(&state.pool, personne_id).await
}
