...
Gérer les créneaux horaires récurrents des activités (jours, horaires), les semaines banalisées (exclusions), et offrir une vue planning hebdomadaire par personne avec détection de collisions à l'inscription.
